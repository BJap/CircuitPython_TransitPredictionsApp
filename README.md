...
Be sure to have the **CircuitPython 10.x** UF2 firmware installed on the Matrix Portal S3 before doing this. The instructions to do this can be found [here](https://learn.adafruit.com/adafruit-matrixportal-s3/install-circuitpython).
...
8. Make a `lib` folder (if it does not exist yet) in the root directory of the boardCopy the following **Adafruit 10.x CircuitPython** libraries into it:
